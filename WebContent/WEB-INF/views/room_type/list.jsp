...
<div id="add-dialog" class="easyui-dialog" data-options="closed:true,iconCls:'icon-save'" style="width:420px; padding:10px;">
	<form id="add-form" method="post">
        <table>
            ...
            <tr>
                <td align="right">推荐分数:</td>
                <td><input type="text" id="recommendAdd" name="recommend" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'默认为0'" /></td>
            </tr>
            <tr>
	...
	<form id="edit-form" method="post">
        ...
        <table>
           ...
           <tr>
            ...
            <tr>
                <td align="right">推荐分数:</td>
                <td><input type="text" id="recommendEdit" name="recommend" class="wu-text easyui-validatebox" data-options="required:true, missingMessage:'请输入整数'" /></td>
            </tr>
            <tr>
                <td align="right">床位数:</td>
	...
	function openEdit(){
		...
		$('#edit-dialog').dialog({
            ...
            onBeforeOpen:function(){
                ...
                $("#recommendEdit").val(item.recommend);
	...
	*/
	$('#data-datagrid').datagrid({
		...
		columns:[[
            ...
            { field:'recommend',title:'推荐分数',width:70,sortable:true},
